...
<?php for ($i = 0; $i < count($jobs); $i++):?>
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]['from']; ?> - <?php if ($jobs[$i]['to'] == 'Current'): ?> <span class="w3-tag w3-teal w3-round">Current</span> <?php else: echo $jobs[$i]['to']; endif; ?></h6>
            <p><?php echo $jobs[$i]['desc']; ?></p>
            <hr>
          </div>
<?php endfor;?>
        </div>
